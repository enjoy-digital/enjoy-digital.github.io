...
DRAM controllers, PCIe, Ethernet, all the fun stuff) in Python, and deploy them
on more than a hundred boards. The motto has been the same from day one:

> **Build your hardware, easily!**

This blog is where I write up things I'm experimenting with. Some are features
landing in LiteX, some are detours, some are just me checking whether an idea
actually works.
...
The work and ideas here are my own. I write up the posts and draw the diagrams with AI in the
loop, which I've come to think is just part of how RTL gets built now.

It also helps with a more practical constraint: I have four kids, I try to keep weekends for
them, and my time is tight. Without a bit of help like this, the blog would probably just not
exist. 🙂
